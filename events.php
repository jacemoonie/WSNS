        ...
        <div class="right-section right-msg col-sm-5">
            ...
            <div class="no-msg-container">
                <div class="n-msg-wrapper">
                    <h2 class="">You don't have a events selected</h2>
                    <p class="">Choose one from your existing events or create a new one.</p>
                    <a href="<?php echo url_for("messages/compose") ?>" class="n-msg Button" role="button" data-focusable="true" data-bs-toggle="modal" data-bs-target="#newGroupMessageModal">Create new events</a>
