...
if(is_post_request()){
    if(isset($_POST['searchParticipant']) && !empty($_POST['searchParticipant'])){
        $userid = h($_POST['userId']);
        $search = FormSanitizer::formSanitizerString($_POST['searchParticipant']);
                        ...
                        <div class="ment-w-container">
                            ...
                            <div class="ment-profile-wrapper">
                                ...
                                <div class="col-3 add-participant-btn" > 
                                    <button id="add-participant" data-uid="'.$user->user_id.'" class="Button">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
